...
public class Lunch extends Fragment {
    RecyclerView lunchLayoutrv,lunchLayoutRecylerviewSpecialOffer,lunchLayoutRecylerviewAddon,lunchLayouttestRecyclerView;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.lunch_layout,container,false);
        lunchLayoutrv=view.findViewById(R.id.lunchLayoutRecyclerview);
        lunchLayoutRecylerviewSpecialOffer=view.findViewById(R.id.lunchLayoutRecyclerviewSpecialOffer);
        lunchLayoutRecylerviewAddon=view.findViewById(R.id.lunchLayoutRecyclerviewAddon);
        lunchLayouttestRecyclerView=view.findViewById(R.id.lunchLayouttestRecylerView);

        lunchLayouttestRecyclerView.setNestedScrollingEnabled(false);
        lunchLayoutrv.setNestedScrollingEnabled(false);
        lunchLayoutRecylerviewAddon.setNestedScrollingEnabled(false);
        lunchLayoutRecylerviewSpecialOffer.setNestedScrollingEnabled(false);
        ...
        lunchLayouttestRecyclerView.setLayoutManager(testLinearLayout);
        lunchLayoutrv.setLayoutManager(linearLayoutManager);
        lunchLayoutRecylerviewAddon.setLayoutManager(linearLayoutManager2);
        lunchLayoutRecylerviewSpecialOffer.setLayoutManager(linearLayoutManager3);
        ...
        lunchLayouttestRecyclerView.setAdapter(testAdapter);
        ...
        lunchLayoutrv.setAdapter(adapter);*/
        al=new ArrayList<>();
        ...
        lunchLayoutRecylerviewSpecialOffer.setAdapter(adapter2);
        ...
        lunchLayoutRecylerviewAddon.setAdapter(adapter3);
        return view;
    }
}
